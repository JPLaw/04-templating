...
// Because .sort has two arguments being passed through whereas "articleObject" and "article" has one (but could take two if needed, and then would need the parantheses.
rawData.sort((a,b) => {
